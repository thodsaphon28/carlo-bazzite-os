...
- Then rebase to the signed image, like so:
  ```
  rpm-ostree rebase ostree-image-signed:docker://ghcr.io/ismaeljcarlo/carlo-bazzite-os:latest
  ```
...
```bash
cosign verify --key cosign.pub ghcr.io/ismaeljcarlo/carlo-bazzite-os
```
